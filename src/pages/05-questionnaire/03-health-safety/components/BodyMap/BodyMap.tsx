...
> = {
  ...
  "back-chest": "Upper Back",
  "back-abdomen": "Lower Back",
  "back-pelvis": "Glutes and Pelvis",
  "back-left-upper-arm":
    "Left Upper Arm",
...
export default function BodyMap() {
  ...
  const [
    ...
    useState<BodyRegionSelection | null>(
      null,
    );
...
const markedRegions =
  ...
  return (
    ...
    >
      ...
      <p>
        Select an area to mark any
        boundaries, sensitivities, or
        medical considerations your
      ...
      {markedRegions.length > 0 && (
        ...
        >
          ...
          <p>
            Add anything your partner
            should know about the areas
            you marked.
          </p>
